...
<!--
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><img src="../../programs/img/xexec-logo-us.png" alt="Xexec in the US"></a>
            </div>
  ...
  <source src="../../programs/img/20161017_video_BG_variation_2_compressed_LQ.mp4" type="video/mp4" />
  </video>
</div>
...
<polyline class="tick path" style="stroke:#57595B;stroke-width:5;" 				points="25,27  25,20 "/>
    ...
    <section id="crowdsourced">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center"><img src="../../programs/img/crowdsourced-mi-data2.png" width="100%"/></div>
                ...
                <div class="col-lg-12 text-center">
                   <!--<h2 class="section-heading">Global employee recognition <br>with local rewards</h2>-->
                    ...
                    <p>Recognize your people wherever they’re based.</p>
                     ...
                     <img src="../../programs/img/global-map.jpg" width="100%"/>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
			...
			<p><img src="../../programs/img/sytner-logo.jpg"/></p>
      </div>
      ...
      <div class="item">
			...
			<p><img src="../../programs/img/anglian-water.jpg"/></p>
      </div>
		...
		<div class="item">
			...
			<p><img src="../../programs/img/cancer-research.jpg"/></p>
      </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.0/Chart.min.js"></script>  
    ...
    <script type="text/javascript" src="../../programs/js/countUp.js"></script> 
