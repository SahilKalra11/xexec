...
<head>
    ...
    <meta charset="utf-8">
    <title>Building an effective recognition strategy</title> 
...
<body id="page-top" class="index">
    ...
    <!-- About Section -->
    <section id="EbookArea">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-heading">Building an effective recognition strategy</h2>
                </div>
            </div>

            <div class="row">
                <div class="col-lg-6">
                    <p>Learn the essentials of planning and implementing a successful employee recognition strategy - with a case study from Anglian Water.</p>
                    <p>In this e-Book, we provide guidance on planning and implementing a recognition strategy. </p>
                    <div class="discover-list">
                        <p>In this e-Book, discover:</p>
                        <ul>
                            <li> What recognition is.</li>
                            <li> The link between recognition and motivation amongst staff.</li>
                            <li> The importance of a clear vision when developing a recognition program.</li>
                            <li> How to obtain buy-in from leadership.</li>
                            <li> Questions to ask when formulating your recognition strategy.</li>
                            <li> Four practical lessons from implementing recognition programs.</li>
                            <li> A case study from Anglian Water including tips on critical success factors.</li>
                        </ul>
                    </div>
                    <div class="hubsport-form">
                        <!--[if lte IE 8]>
                        ...
                        <script>
                            hbspt.forms.create({
                                portalId: "2195820",
                                formId: "814760ee-73c0-43a5-b8d3-f9c0e911ae9b"
                            });
                        </script>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="latest-download-sec">
                        <h3>Latest Downloads</h3>
                        <ul>
                            <li><a href="/en-us/why-employee-recognition-so-important-e-book">Why is Employee Recognition so Important?</a></li>
                            <li><a href="/en-us/employee-recognition-modern-workforce-e-book">Employee Recognition for the Modern workforce:</a></li>
                            <li><a href="/en-us/how-to-build-effective-recognition-strategy-e-book">Building an effective recognition strategy</a></li>
                            <li><a href="/en-us/how-implement-successful-global-reward-and-recognition-programme-e-book">Global Reward and Recognition + Colt Case study</a></li>
                        <ul>
                    </div>
                </div>
            </div>
