...
<head>
    ...
    <meta charset="utf-8">
    <title>Career & Job Opportunities at Xexec - Join Our Growing Team</title> 
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Want to join our growing team? Have a look at our various career opportunities in the team. If nothing is of interest contact us with your details.">
...
<body id="page-top" class="index">
	...
	<section id="masthead" style="background-image: url(../../programs/img/careers-bg.jpg)">
	<div class="overlay"></div>
        <div class="container">
          <div class="row">
                ...
                <p>Want to join our growing team? Learn more about job opportunities at Xexec.</p>
             </div>
            </div>
             </div>
    ...
    <section id="aboutus">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">View our vacancies</h2>
                   <a href="https://xexec.bamboohr.com/jobs/">click here</a>
